...
- For web discovery, prefer web_search. For full page content, use web_get_contents.
- Use the browser (computer tool) for login flows, UI verification, and JavaScript-rendered pages.
- Use grep and find_file_by_name for codebase exploration before resorting to broad shell commands.
